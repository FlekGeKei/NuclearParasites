...
mods.ntm.Anvil.addRecipe(<portality:frame>*2, [<hbm:plate_desh>*4, <hbm:coil_gold_torus>*4, <hbm:coil_gold>, <hbm:wire_gold>*6, <ore:oc:circuitChip3>*2, <hbm:levitation_unit>], 6);
